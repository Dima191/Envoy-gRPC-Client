...
type Config struct {
	...
	EnvoyProtectedListenPort   uint32 `yaml:"envoy_protected_listen_port" env-required:"true"`
	EnvoyUnprotectedListenPort uint32 `yaml:"envoy_unprotected_listen_port" env-required:"true"`
}
